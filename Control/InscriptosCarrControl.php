...
class InscriptosCarrControl{
	...
	public function index(){
		...
		$data["inscriptos"] = $inscriptos->get_insc_carr();
		$data["titulo"] = "Inscriptos carreras";

		require_once"Vista/Inscriptos/inscriptoscarr.php";
	}
	...
	public function nuevo(){
		...
		$data1[0] = $carreras->get_carreras();

		$ciclos = new CiclosModelo();
		$data2[0] = $ciclos->get_ciclos_carr();


		$data["titulo"] = "Cargar Nuevo Inscripto";

		require_once"Vista/Inscriptos/inscriptoscarr_n.php";
	...
	public function mostrar($idinsc){
		...
		require_once"Vista/Inscriptos/inscriptoscarr_m.php";
	}

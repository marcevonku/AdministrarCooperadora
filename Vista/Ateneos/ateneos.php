...
<head>
	...
	<link rel=icon href='../Imagen/logo-icon.png' sizes="32x32" type="image/png">	
</head>
<body>
	<div class="zocalo">
		<div class="logo">
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Ateneos&a=nueva" title="">NUEVO</a></li>
		</ul>
	</div>	
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Ateneos&a=imprimir" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<tbody>
				<?php foreach($data["carreras"] as $dato) {
					...
					echo "<td><a href='index.php?c=Ateneos&a=mostrar&id=".$dato["idcarrera"]."'>Modificar</a></td>";
					echo "<td><a href='index.php?c=Ateneos&a=eliminar&id=".$dato["idcarrera"]."'>Eliminar</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

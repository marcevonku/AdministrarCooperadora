...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Ateneos" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Ateneos&a=modificar" method="POST" accept-charset="utf-8" autocomplete="off">

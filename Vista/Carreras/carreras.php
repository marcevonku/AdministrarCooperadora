...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Carreras&a=nueva" title="">NUEVO</a></li>
		</ul>
	</div>	
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Carreras&a=imprimir" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<tbody>
				<?php foreach($data["carreras"] as $dato) {
					echo "<tr>";
						...
						echo "<td><a href='index.php?c=Carreras&a=materias&id=".$dato["idcarrera"]."'>MATERIAS</a></td>";
						echo "<td><a href='index.php?c=Carreras&a=mostrar&id=".$dato["idcarrera"]."'>MODIFICAR</a></td>";
						echo "<td><a href='index.php?c=Carreras&a=eliminar&id=".$dato["idcarrera"]."'>ELIMINAR</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=CiclosAte" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosAte&a=actualizarciclo" method="post" accept-charset="utf-8">
		...
		Detalle:
		<input type="text" class="texto" name="detalle" value="<?php echo $data['ciclo']['detalle'] ?>" placeholder="Indicar a que Atenéo aplica" require="">				
		Año:
		<input type="number" min="2009" max="2025" class="texto" name="anio" value="<?php echo $data['ciclo']['anio']?>" placeholder="Año al que aplica" require="" >
		Valor Inscripción:
		<input type="number" class="texto" name="inscripcion" value="<?php echo $data['ciclo']['inscripcion']?>" placeholder="Valor Inscipción"><br>				
		Valor Cuota:

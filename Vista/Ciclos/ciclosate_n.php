...
<body>
	...
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosAte&a=guarda" method="post" accept-charset="utf-8">
		<h2><?php echo $data['titulo']; ?></h2>
		<br>
		Detalle:
		<input type="text" class="texto" name="detalle" value="" placeholder="Indicar a que Atenéo aplica" required="">
		Año:

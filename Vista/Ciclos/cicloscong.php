...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=CiclosCong&a=nueva" title="">NUEVO</a></li>	
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form  class="datos1" action="index.php?c=CiclosCong&a=Imprimir" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<tbody>
				<?php foreach($data["ciclos"] as $dato){
					...
					echo "<td><a href='index.php?c=CiclosCong&a=mostrar&id=".$dato["idciclo"]."'>Modificar</a></td>";
					echo "<td><a href='index.php?c=CiclosCong&a=eliminar&id=".$dato["idciclo"]."'>Eliminar</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

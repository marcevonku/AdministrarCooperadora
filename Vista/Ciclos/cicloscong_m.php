...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Vista/css/carreras_m.css">	
</head>
<body>
	<div class="zocalo">
		<div class="logo">
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=CiclosCong" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosCong&a=actualizarciclo" method="post" accept-charset="utf-8">

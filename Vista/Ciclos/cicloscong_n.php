...
<body>
	...
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosCong&a=guarda" method="post" accept-charset="utf-8">
		<h2><?php echo $data['titulo']; ?></h2>
		<br>
		Detalle:
		<input type="text" class="texto" name="detalle" value="" placeholder="Indicar si se aplica Carrera/Curso/Postgrado/etc." required="">
		Año:
		<input type="number" class="texto" name="anio" value="" placeholder="Colocar año a que se aplica" required="" min="2009" max="2030">
		Valor Inscripción:

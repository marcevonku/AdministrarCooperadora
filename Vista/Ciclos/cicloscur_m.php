...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=CiclosCur" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosCur&a=actualizarciclo" method="post" accept-charset="utf-8">
		<h2><?php echo $data['titulo'] ?></h2>
		<br>
		<input type="hidden" id="idciclo" name="idciclo" value="<?php echo $data["idciclo"] ?>" placeholder="">

		Detalle:
		<input type="text" class="texto" name="detalle" value="<?php echo $data['ciclo']['detalle'] ?>" placeholder="Curso a que se aplica" require>				
		Año:
		<input type="number" min="2009" max="2025" class="texto" name="anio" value="<?php echo $data['ciclo']['anio']?>" placeholder="Año a que se aplica" require="" >
		Valor Inscripción:
		<input type="number" class="texto" name="inscripcion" value="<?php echo $data['ciclo']['inscripcion']?>" placeholder="Valor Inscripción" require="" >
		Valor Cuota:

...
<body>
	...
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosCur&a=guarda" method="post" accept-charset="utf-8">
		<h2><?php echo $data['titulo']; ?></h2>
		<br>
		Detalle:
		<input type="text" class="texto" name="detalle" value="" placeholder="A que Curso Apllica" required="">
		Año Ciclo:
		<input type="number" class="texto" name="anio" value="" placeholder="Año a que se aplica" required="" min="2009" max="2025">
		Valor Inscripción:

...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=CiclosPost" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=CiclosPost&a=actualizarciclo" method="post" accept-charset="utf-8">
		...
		Detalle:
		<input type="text" class="texto" name="detalle" value="<?php echo $data['ciclo']['detalle'] ?>" placeholder="Postítulo al que se aplica" require>				
		Año:
		<input type="number" min="2009" max="2030" class="texto" name="anio" value="<?php echo $data['ciclo']['anio']?>" placeholder="Año al que se aplica" require="" >
		Valor Inscripción:
		<input type="number" class="texto" name="inscripcion" value="<?php echo $data['ciclo']['inscripcion']?>" placeholder="Valor Inscripción"><br>				
		Valor Cuota:
		<input type="number" class="texto" name="cuota" value="<?php echo $data['ciclo']['cuota']?>" placeholder="Valor Cuota" require="">
		<br><br>

...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Congresos&a=nueva" title="">NUEVO</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>	
	<form class="datos1" action="index.php?c=Congresos&a=imprimir" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<tbody>
				<?php foreach($data["carreras"] as $dato) {
					...
					echo "<td><a href='index.php?c=Congresos&a=mostrar&id=".$dato["idcarrera"]."'>Modificar</a></td>";
					echo "<td><a href='index.php?c=Congresos&a=eliminar&id=".$dato["idcarrera"]."'>Eliminar</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

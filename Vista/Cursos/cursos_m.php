...
<body>
	...
	<br>
	<br>
	<form class="datos1" action="index.php?c=Cursos&a=modificar" method="POST" accept-charset="utf-8" autocomplete="off">
		<h2><?php echo $data["titulo"]; ?></h2>
		<br>
		<input type="hidden" id="idcarrera" name="idcarrera" value="<?php echo $data["idcarrera"] ?>">
		Nombre Curso:
		<input class="texto" type="text" id="nombrecarrera" name="nombrecarrera" value="<?php echo $data["carreras"]["nombrecarrera"]?>" placeholder="" require=""><br>
		Resolución N°:
		<input class="texto" type="text" id="resolucion" name="resolucion" value="<?php echo $data["carreras"]["resolucion"]?>" pattern="^[0-9]{5}-[a-zA-Z]{5}-[0-9]{4}$" placeholder="" require=""><br>
		Año de Alta:
		<input class="texto" type="date" id="fechaalta" name="fechaalta" value="<?php echo $data["carreras"]["fechaalta"]?>" placeholder="" min="2009-01-01" max="2025-01-01" require=""><br>
		Año de Baja: 
		<input class="texto" type="date" id="fechabaja" name="fechabaja" value="<?php echo $data["carreras"]["fechabaja"]?>" placeholder="" min="2009-01-01" max="2025-01-01" require="">
		<br><br>

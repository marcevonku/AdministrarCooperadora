...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Miembros" title="">ACTUALIZAR</a></li>
		</ul>
	</div>
	<br>
	<form class="datos1" action="index.php?c=Miembros" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<thead>
				<tr>
					<th>FECHA</th>
					<th>DETALLE</th>
					<th>INGRESOS<br>ACUMULADOS</th>
					<th>EGRESOS<br>ACUMULADOS</th>
					<th>SALDOS<br>DISPONIBLES</th>
				</tr>
				<tbody>
					<?php foreach($data["miembros"] as $dato) {
						echo "<tr>";
						echo "<td>".$dato["fecha"]."</td>";
						echo "<td>".$dato["detalle"]."</td>";
						echo "<td style='text-align:right'>".$dato["debe"]."</td>";
						echo "<td style='text-align:right'>".$dato["haber"]."</td>";
						echo "<td style='text-align:right'>".$dato["saldo"]."</td>";
						echo "</tr>";
					}?>
				</tbody>
				<tfoot>

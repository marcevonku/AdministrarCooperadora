...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Destinos&a=nueva" title="">NUEVO</a></li>
		</ul>
	</div>	
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Destinos&a=imprimir" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<tbody>
				<?php foreach($data["destinos"] as $dato) {
					echo "<tr>";
					...
					echo "<td><a href='index.php?c=Destinos&a=mostrar&id=".$dato["idcaja"]."'>Modificar</a></td>";
					echo "<td><a href='index.php?c=Destinos&a=eliminar&id=".$dato["idcaja"]."'>Eliminar</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

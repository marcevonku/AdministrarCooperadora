...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Facturas&a=nueva" title="">NUEVO</a></li>
		</ul>
	</div>	
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Facturas&a=imprimir" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<tbody>
				<?php foreach($data["carreras"] as $dato) {
					...
					echo "<td><a href='index.php?c=Facturas&a=mostrar&id=".$dato["idcaja"]."'>Modificar</a></td>";
					echo "<td><a href='index.php?c=Facturas&a=eliminar&id=".$dato["idcaja"]."'>Eliminar</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

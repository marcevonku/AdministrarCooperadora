...
<body>
	...
	<br>
	<br>
	<form class="datos1" action="index.php?c=Facturas&a=modificar" method="post" accept-charset="utf-8" autocomplete="off">
		...
		FECHA:
		<br>
		<input type="date" class="texto" id="fecha" name="fecha" value="<?php echo $data["facturas"]["fecha"] ?>" required="">
		<br>
		FACTURA N°:
		<br>
		<input type="text" class="texto" id="facturaid" name="facturaid" value="<?php echo $data["facturas"]["facturaid"] ?>" required="">
		<br>
		DETALLE:
		<br>
		<textarea name="detalle" class="texto" value="" required=""><?php echo $data["facturas"]["detalle"]?></textarea>
		<br>
		MONTO:
		<br>
		<input type="text" class="texto" id="egreso" name="egreso" value="<?php echo $data["facturas"]["egreso"] ?>" required="">
		<br>
		<br>

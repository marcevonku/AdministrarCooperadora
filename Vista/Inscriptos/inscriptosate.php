...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosAte&a=nuevo" title="">NUEVO</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=InscriptosAte&a=imprimir" method="POST" accept-charset="utf-8">
		...
		<table border="1">
			...
			<tbody>
				<?php foreach($data["inscriptos"] as $dato) {
					...
					echo "<td><a href='index.php?c=InscriptosAte&a=mostrar&id=".$dato["idinsc"]."'>MODIFICAR</a></td>";
					echo "<td><a href='index.php?c=InscriptosAte&a=eliminar&id=".$dato["idinsc"]."'>ELIMINAR</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

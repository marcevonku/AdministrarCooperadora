...
<div id="cabecera">
	<ul class="navegador">
		...
		<li><a href="index.php?c=InscriptosAte" title="">LISTAR</a></li>
	</ul>
</div>
	<br>
	<br>
	<br>
<body>
	<form class="datos1" name="buscar" action="index.php?c=InscriptosAte&a=nuevo" method="post" accept-charset="utf-8">
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosAte&a=nuevo" method="post" accept-charset="utf-8">	

		<h2><?php echo $data["titulo"];?></h2>
		APELLIDO:<br>
		<input class="texto" type="text" name="apellido" value="<?php echo $data['personas']['apellido']; ?>" placeholder="APELLIDO"><br>
		NOMBRE:<br>
		<input class="texto" type="text" name="nombre" value="<?php echo $data['personas']['nombre']; ?>" placeholder="NOMBRE"><br>
		DNI:<br>
		<input class="texto" type="text" name="dni" value="<?php echo $data['personas']['dni']; ?>"placeholder="DNI"><br>
		EMAIL:<br>
		<input class="texto"  type="text" name="mail" value="<?php echo $data['personas']['mail']; ?>" placeholder="EMAIL">	
	</form>	
	<form class="datos1" name="finsc" action="index.php?c=InscriptosAte&a=guarda" id="ferecibo" method="post" accept-charset="utf-8">
		FECHA:
		<br>

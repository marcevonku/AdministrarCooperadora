...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosCarr&a=nuevo" title="">NUEVO</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=inscriptos&a=imprimir" method="POST" accept-charset="utf-8">
		<table border="1">
			...
			<thead>
				<tr>
					...
					<th>Nombre</th>
					<th>Nom.Carrera</th>
					<th width="150px">Resolución</th>
					<th width="40px">Cohorte</th>
					<th>Modificar</th>
					<th>Eliminar</th>
				</tr>
			</thead>
			<tbody>
				<?php foreach($data["inscriptos"] as $dato) {
					...
					echo "<td><a href='index.php?c=InscriptosCarr&a=mostrar&id=".$dato["idinsc"]."'>MODIFICAR</a></td>";
					echo "<td><a href='index.php?c=InscriptosCarr&a=eliminar&id=".$dato["idinsc"]."'>ELIMINAR</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

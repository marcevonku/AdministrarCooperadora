...
<body>
	...
	<br>
	<br>
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCarr&a=modificar" method="post" accept-charset="utf-8">	
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCarr&a=modificar" id="ferecibo" method="post" accept-charset="utf-8">
		...
		<select class="texto" id="finsc" name="carreraid">
			<option value="<?php echo $data["carrera"]['idcarrera']?>"><?php echo $data["carrera"]["nombrecarrera"]?></option>
			<?php  

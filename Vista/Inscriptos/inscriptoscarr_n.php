...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosCarr" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" name="buscar" action="index.php?c=InscriptosCarr&a=nuevo" method="post" accept-charset="utf-8">
		...
		<br>
		<br>		
		<input class='boton' type="submit" name="" id="buscar" value="BUSCAR PERSONA">
		<br>	
	</form >
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCarr&a=nuevo" method="post" accept-charset="utf-8">	
		<h2><?php echo $data["titulo"];?></h2>
		<br>
		APELLIDO:
		<br>
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCarr&a=guarda" id="ferecibo" method="post" accept-charset="utf-8">
		FECHA:
		<br>
		...
		<br>
		<br>
		<input class="boton" id="finsc" type="submit" name="" value="INSCRIBIR" >
		<br>
	</form>
</body>
</html>
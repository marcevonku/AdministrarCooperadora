...
<body>
	...
	<br>
	<br>
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCur&a=modificar" method="post" accept-charset="utf-8">	
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCur&a=modificar" id="ferecibo" method="post" accept-charset="utf-8">

...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosCur" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" name="buscar" action="index.php?c=InscriptosCur&a=nuevo" method="post" accept-charset="utf-8">
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCur&a=nuevo" method="post" accept-charset="utf-8">	
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosCur&a=guarda" id="ferecibo" method="post" accept-charset="utf-8">
		<br>

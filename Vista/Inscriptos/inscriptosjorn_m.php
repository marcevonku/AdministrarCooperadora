...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosJorn" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" name="finsc" action="index.php?c=InscriptosJorn&a=modificar" method="post" accept-charset="utf-8">	
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosJorn&a=modificar" id="ferecibo" method="post" accept-charset="utf-8">
		...
		<select class="texto" id="finsc" name="carreraid">
			<option value="<?php echo $data["carrera"]['idcarrera']?>"><?php echo $data["carrera"]["nombrecarrera"]?>Selecciones jornada</option>
			<?php  
		...
		<select class="texto" id="finsc" name="cicloid">
			<option value="<?php echo $data["ciclo"]['idciclo']?>"><?php echo $data["ciclo"]["anio"]?>Seleccione ciclo</option>
			<?php  

...
<body>
	...
	<br>
	<br>
	<form class="datos1" name="buscar" action="index.php?c=InscriptosJorn&a=nuevo" method="post" accept-charset="utf-8">
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosJorn&a=nuevo" method="post" accept-charset="utf-8">	
		<h2><?php echo $data["titulo"];?></h2>
		<br>
		APELLIDO:
		<br>
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosJorn&a=guarda" id="ferecibo" method="post" accept-charset="utf-8">
		FECHA:
		<br>

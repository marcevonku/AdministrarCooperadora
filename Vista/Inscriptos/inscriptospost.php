...
<body>
	<div class="zocalo">
		...
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosPost&a=nuevo" title="">NUEVO</a></li>
		</ul>
	</div>
	<br>
	<br>
		...
		<table border="1">
			...
			<tbody>
				<?php foreach($data["inscriptos"] as $dato) {
					...
					echo "<td><a href='index.php?c=InscriptosPost&a=mostrar&id=".$dato["idinsc"]."'>MODIFICAR</a></td>";
					echo "<td><a href='index.php?c=InscriptosPost&a=eliminar&id=".$dato["idinsc"]."'>ELIMINAR</a></td>";
					echo "</tr>";
				}?>
			</tbody>
			<tfoot>

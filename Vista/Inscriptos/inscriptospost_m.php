...
<body>
	...
	<br>
	<br>
	<form class="datos1" name="finsc" action="index.php?c=InscriptosPost&a=modificar" method="post" accept-charset="utf-8">	
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosPost&a=modificar" id="ferecibo" method="post" accept-charset="utf-8">
		...
		<select class="texto" id="finsc" name="carreraid">
			<option value="<?php echo $data["carrera"]['idcarrera']?>"><?php echo $data["carrera"]["nombrecarrera"]?>Seleccionar postítulo</option>
			<?php  

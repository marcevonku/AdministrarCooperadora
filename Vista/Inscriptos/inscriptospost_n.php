...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=InscriptosPost" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" name="buscar" action="index.php?c=InscriptosPost&a=nuevo" method="post" accept-charset="utf-8">
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosPost&a=nuevo" method="post" accept-charset="utf-8">	
	...
	<form class="datos1" name="finsc" action="index.php?c=InscriptosPost&a=guarda" id="ferecibo" method="post" accept-charset="utf-8">
		FECHA:
		<br>
		...
		<select class="texto" id="finsc" name="carreraid">
			<option value="">Seleccionar Postítulo</option>
			<?php  

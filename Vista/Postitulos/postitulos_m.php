...
<body>
	<div class="zocalo">
		...
		<ul class="navegador">
			...
			<li><a href="index.php?c=Postitulos" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Postitulos&a=modificar" method="POST" accept-charset="utf-8" autocomplete="off">

		<h2><?php echo $data["titulo"];?></h2>
		<br>
		<input type="hidden" id="idcarrera" name="idcarrera" value="<?php echo $data["idcarrera"] ?>"/>
		Nombre Postitulo: 
		<input class="texto" type="text" id="nombrecarrera" name="nombrecarrera" value="<?php echo $data["carreras"]["nombrecarrera"]?>" placeholder="" required="" >
		<br>
		Resolución N°: 
		<input class="texto" type="text" id="resolucion" name="resolucion" value="<?php echo $data["carreras"]["resolucion"]?>" placeholder="Res.N°:00000-DDDDD-9999" pattern="^[0-9]{5}-[a-zA-Z]{5}-[0-9]{4}$" required="">
		<br>
		Año de Alta: 

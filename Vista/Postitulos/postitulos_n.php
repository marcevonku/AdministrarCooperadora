...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			<li><a href="?c=Menu" title="">SALIR</a></li>
			<li><a href="?c=Postitulos" title="">LISTAR</a></li>
		</ul>
	</div>
	<br>
	<br>
	...
	<form class="datos1" action="index.php?c=Postitulos&a=guarda" method="post" accept-charset="utf-8" autocomplete="off">
		...
		Resolución N°:
		<input class="texto" type="text" id="resolucion" name="resolucion" value="" placeholder="Res.N°:00000-DDDDD-9999" pattern="^[0-9]{5}-[a-zA-Z]{5}-[0-9]{4}$" required="">
		Año de Alta:
		<input class="texto" type="date" id="fechaalta" name="fechaalta" value="" placeholder="" required="" min="2009-01-01" max="2025-01-01">
		Año de Baja:
		<input class="texto" type="date" id="fechabaja" name="fechabaja" value="" placeholder="" required="" min="2009-01-01" max="2025-01-01">
		<br><br>

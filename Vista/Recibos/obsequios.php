...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Obsequios&a=nuevo" title="">NUEVO</a></li>
		</ul>
	</div>
	<br>
	<br>
	<br>
	<form class="datos1" action="index.php?c=Obsequios&a=imprimir" name="admin" method="POST" accept-charset="utf-8">
		<table border="1">

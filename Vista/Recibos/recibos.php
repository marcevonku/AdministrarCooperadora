...
<body>
	...
	<div id="cabecera">
		<ul class="navegador">
			...
			<li><a href="index.php?c=Recibos&a=nuevo" title="">NUEVO</a></li>
		</ul>
	</div>
	<br>
	<br>
			...
			<thead>
				...
				<tbody>
					<?php foreach($data["recibos"] as $dato) {
						...
						echo "<td><a href='index.php?c=Recibos&a=imprimir&id=".$dato["idrecibo"]."'>PDF</a></td>";
						echo "</tr>";
						echo "<td><a href='index.php?c=Recibos&a=modificar&id=".$dato["idrecibo"]."'>ADM</a></td>";
						echo "</tr>";
					}?>
				</tbody>
				<tfoot>
